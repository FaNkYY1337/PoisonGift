...
# При повторном сливе, указывать автора: @axohu
...
ADMIN_ID = 913324178
WEB_APP_URL = "https://poisongift.onrender.com"
DATA_FILE = 'data.json'
...
# Главный роут для открытия оригинального index.html в Телеграм WebApp
@app.route('/')
def index():
...
if __name__ == '__main__':
    ...
    # 1. Запуск Flask сервера в отдельном потоке под Render
    flask_thread = Thread(target=run_flask)
    flask_thread.daemon = True
    flask_thread.start()
    
    # 2. Правильный асинхронный запуск Телеграм-бота
